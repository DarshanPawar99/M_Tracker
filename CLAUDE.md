...
Ponytail (lazy senior dev mode), vendored from
github.com/DietrichGebert/ponytail v4.10.0, MIT. Inlined here because the
plugin doesn't load in remote sessions.
...
Switch by saying "ponytail lite" / "ponytail ultra".
